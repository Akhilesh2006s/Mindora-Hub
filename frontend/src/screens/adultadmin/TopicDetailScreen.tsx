...
const TopicDetailScreen: React.FC<TopicDetailScreenProps> = ({ navigation, route }) => {
  ...
  const loadTopicContent = async () => {
    try {
      ...
      const [videosRes, questionsRes, notesRes, linksRes] = await Promise.all([
        fetch(`https://oyster-app-qlg6z.ondigitalocean.app/api/adult-modules/${moduleId}/topics/${topicId}/videos`, {
          headers: { 'Cache-Control': 'no-cache' }
        }),
        fetch(`https://oyster-app-qlg6z.ondigitalocean.app/api/adult-modules/${moduleId}/topics/${topicId}/questions`, {
          headers: { 'Cache-Control': 'no-cache' }
        }),
        fetch(`https://oyster-app-qlg6z.ondigitalocean.app/api/adult-modules/${moduleId}/topics/${topicId}/notes`, {
          headers: { 'Cache-Control': 'no-cache' }
        }),
        fetch(`https://oyster-app-qlg6z.ondigitalocean.app/api/adult-modules/${moduleId}/topics/${topicId}/links`, {
          headers: { 'Cache-Control': 'no-cache' }
        })
      ]);
  ...
  const uploadVideo = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://oyster-app-qlg6z.ondigitalocean.app/api/adult-modules/${moduleId}/topics/${topicId}/videos`, {
        method: 'POST',
        body: formData,
  ...
  const addQuestion = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://oyster-app-qlg6z.ondigitalocean.app/api/adult-modules/${moduleId}/topics/${topicId}/questions`, {
        method: 'POST',
        headers: {
  ...
  const uploadNote = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://oyster-app-qlg6z.ondigitalocean.app/api/adult-modules/${moduleId}/topics/${topicId}/notes`, {
        method: 'POST',
        body: formData,
        // Don't set Content-Type header - let fetch set it automatically for multipart/form-data
      });
  ...
  const addLink = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://oyster-app-qlg6z.ondigitalocean.app/api/adult-modules/${moduleId}/topics/${topicId}/links`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
