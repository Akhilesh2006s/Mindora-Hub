...
const EnhancedLessonManagementScreen: React.FC<EnhancedLessonManagementScreenProps> = ({ navigation, route }) => {
  ...
  const saveAllLessonsToBackend = async () => {
    try {
      ...
      const checkResponse = await fetch('https://oyster-app-qlg6z.ondigitalocean.app/api/lessons');
      if (checkResponse.ok) {
      ...
      try {
        const result = await apiService.post('/lessons/save', { lessons: lessonsData });
  ...
  const handleAddLesson = async () => {
    ...
    try {
      ...
      const response = await fetch('https://oyster-app-qlg6z.ondigitalocean.app/api/lessons', {
        method: 'POST',
        headers: {
      ...
      Alert.alert(
        ...
        [
          { text: 'Cancel', style: 'cancel' },
          {
            ...
            onPress: async () => {
              try {
                const response = await fetch('https://oyster-app-qlg6z.ondigitalocean.app/api/lessons/sync-to-modules', {
                  method: 'POST',
                  headers: {
                    'Content-Type': 'application/json',
                  },
  ...
  const handleAddTopic = async () => {
    ...
    try {
      const response = await fetch(`https://oyster-app-qlg6z.ondigitalocean.app/api/lessons/${selectedLesson._id}/topics`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
